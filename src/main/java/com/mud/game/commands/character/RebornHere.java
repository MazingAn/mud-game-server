...
public class RebornHere extends BaseCommand {
     ...
     */
    public RebornHere(String key, Object caller, JSONObject args, Session session) {
    ...
    public void execute() throws JSONException {
        ...
        PlayerCharacterManager.rebornHere(playerCharacter);
    }
}
