...
public class CommandSetHandler {
    ...
    public static void initPlayerCharacterCommandSet() {
        ...
        playerCharacterCommandSet.put("pick_up_one", PickUpOne.class);
        playerCharacterCommandSet.put("pick_up_list", PickUpList.class);
        ...
        playerCharacterCommandSet.put("get_login", GetLogin.class);
    }
