...
public class MongoMapper<F, S> {
    ...
    @Autowired
    public void setEnemyRecordObjectRepository(EnemyRecordObjectRepository enemyRecordObjectRepository) {
        MongoMapper.enemyRecordObjectRepository = enemyRecordObjectRepository;
    }
}
