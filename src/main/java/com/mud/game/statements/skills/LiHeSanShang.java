 ...
 * 招架成功后立即反击，持续8秒
 */
public class LiHeSanShang extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public LiHeSanShang(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
