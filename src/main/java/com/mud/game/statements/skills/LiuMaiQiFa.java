 ...
 * 连击6，每命中一次伤害增加50%
 */
public class LiuMaiQiFa extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public LiuMaiQiFa(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
        super(caller, target, skillObject, key, args);
    }

    @Override
    public void attack() throws JSONException, JsonProcessingException {
        AttackAlgorithm.lianji(getCaller(), getTarget(), getSkillObject(), 6, 0.5);
    }
}
