 ...
 * 受到攻击会反伤火焰伤害
 */
public class JiuYangZhenYan extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public JiuYangZhenYan(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    public void attack() throws JSONException, JsonProcessingException {
        ...
        GameCharacterManager.addBuffer("九阳真炎", 5, 0, 1, true,
