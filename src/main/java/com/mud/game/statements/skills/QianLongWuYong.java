 ...
 * 造成200%伤害并使敌人无法招架
 */
public class QianLongWuYong extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public QianLongWuYong(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    public void attack() throws JSONException, JsonProcessingException {
        ...
        //无法招架buffer
        GameCharacterManager.addBuffer("无法招架", 5, 0, 1, false,
