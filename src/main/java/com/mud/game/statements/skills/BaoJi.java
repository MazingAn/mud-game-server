...
/**
 * 造成100%暴击伤害
 * ## 必暴击 在技能攻击时计算暴击以技能函数实现
 */
public class BaoJi extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public BaoJi(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
