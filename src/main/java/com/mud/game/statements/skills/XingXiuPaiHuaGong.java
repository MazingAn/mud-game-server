...
/**
 * 5秒内攻击造成伤害的同时减少敌人伤害200%内力
 */
public class XingXiuPaiHuaGong extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public XingXiuPaiHuaGong(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    public void attack() throws JSONException, JsonProcessingException {
        ...
        beforeAttack();
        //增加一个化功buffer
        GameCharacterManager.addBuffer("化功", 5, 0, 1, true,
