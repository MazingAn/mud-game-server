 ...
 * 造成敌人最大生命值百分20%的伤害
 */
public class LingJiuGongLongZhanYuYe extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public LingJiuGongLongZhanYuYe(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    private HarmInfo computeFinalHarm(CommonCharacter caller, CommonCharacter target, SkillObject skillObject) {
        ...
        // 最大生命值百分20%
        harmInfo.finalHarm = (float) (target.getMax_hp() * 0.2);
