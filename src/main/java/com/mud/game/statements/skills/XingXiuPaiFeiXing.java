 ...
 * 群攻 每命中一个敌人伤害增加30%
 */
public class XingXiuPaiFeiXing extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public XingXiuPaiFeiXing(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
