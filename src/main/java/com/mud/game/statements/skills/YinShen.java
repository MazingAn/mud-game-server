...
/**
 * 隐身不会成为攻击目标，
 * 被隐身角色攻击,只能闪避 招架 不能反击
 */
public class YinShen extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public YinShen(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    public void attack() throws JSONException, JsonProcessingException {
        ...
        beforeAttack();
        //增加一个隐身buffer
        GameCharacterManager.addBuffer("隐身", 5, 0, 1, true,
