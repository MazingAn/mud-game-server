 ...
 * 倒地 不可移动 不可攻击 不可逃跑
 */
public class DaoDi extends BaseAttackSkillStatement {
    /**
     * 攻击技能基类的构造函数
     *
     * @param caller      调用者
     ...
     */
    public DaoDi(CommonCharacter caller, CommonCharacter target, SkillObject skillObject, String key, String[] args) {
    ...
    public void attack() throws JSONException, JsonProcessingException {
        ...
        beforeAttack();
        //增加一个忙乱buffer
        GameCharacterManager.addBuffer("倒地", 5, 0, 1, false,
